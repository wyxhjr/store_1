...
from xmh_embbag_collection import CustomEmbeddingBagCollection 
...
class SparseArch(nn.Module):
    ...
    def __init__(self, embedding_bag_collection: CustomEmbeddingBagCollection) -> None:
        super().__init__()
        self.embedding_bag_collection: CustomEmbeddingBagCollection = embedding_bag_collection
        assert (
...
class DLRM(nn.Module):
    ...
    * num_features: number of dense features
    ...
    def __init__(
        self,
        embedding_bag_collection: CustomEmbeddingBagCollection,
    ...
    def forward(
        ...
        with torch.cuda.nvtx.range("DLRM.dense"):
            embedded_dense = self.dense_arch(dense_features)
        with torch.cuda.nvtx.range("DLRM.sparse"):
            embedded_sparse = self.sparse_arch(sparse_features)
        with torch.cuda.nvtx.range("DLRM.top"):
